...
package com.example.demo.restDemo.client;


import com.alibaba.fastjson.JSONObject;
import com.example.demo.restDemo.HttpClientUtil;
...
public class JsonReqClient extends AbsRestClient {
	...
	public  String sendSms(String sid, String token, String appid, String templateid, String param, String mobile,
		...
		try {
			...
			jsonObject.put("sid", "6446859ad3b1516289cb31c944025158");
			jsonObject.put("token", "1264dd7a4201fbdb616a10de84cdf950");
			jsonObject.put("appid", "a6496ccea15342a9ad2b1d1cf2090a4e");
			jsonObject.put("templateid", "548365");
	...
	public static void main(String[] args) {
		System.out.println(new JsonReqClient().sendSms("","","","","1111","17368150311",""));
	}
}
